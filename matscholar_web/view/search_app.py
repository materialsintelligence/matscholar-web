...
ES_field_dict = {"material": "materials", "property": "properties", "application": "applications",
                 "descriptor": "descriptors", "characterization": "characterization_methods",
                 "synthesis": "synthesis_methods", "phase": "structure_phase_labels"}
...
def serve_layout(path):
    ...
    filter_boxes_and_results = html.Div(
        [html.Div(id="filter-boxes",
                  children=filter_boxes,
                  style={'width': '25%',
                         'float': 'left',
    ...
    layout = html.Div([top, html.Div([search_bar, mat_search, filter_boxes_and_results],
                                     id="search-layout",
